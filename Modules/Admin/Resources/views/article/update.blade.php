				...
				<form id="demo-form2" action="" method="post" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="a_name" type="text" id="first-name" required="required" class="form-control " value="{{ $article->a_name }}">
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<textarea id="editor1" name="a_description" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $article->a_description }}</textarea>
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<textarea id="editor2" name="a_content" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $article->a_content }}</textarea>
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="a_title_seo" type="text" id="first-name" required="required" class="form-control " value="{{ $article->a_title_seo }}">
						</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="a_description_seo" type="text" id="first-name" required="required" class="form-control " value="{{ $article->a_description_seo }}">
						</div>
