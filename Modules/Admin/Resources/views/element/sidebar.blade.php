            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i>Quản trị viên<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ route('admin.manager') }}">Danh sách quản trị viên</a></li>
                      <li><a href="{{ route('admin.manager.create') }}">Thêm quản tri viên</a></li>
