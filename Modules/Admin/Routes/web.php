...
use Modules\Admin\Http\Controllers\AdminManagerController;
...
Route::prefix('admin')->group(function() {
    ...
    Route::middleware('auth:admin')->group(function (){
        ...
        Route::group(['prefix' => $prefix], function() use($controllerName){
            Route::middleware('isAdmin')->group(function() use($controllerName){
        ...
        //admin
        $prefix = 'manager';
        $controllerName = 'admin.manager';   
        Route::group(['prefix' => $prefix], function() use($controllerName) {
            Route::get('/',                   [AdminManagerController::class, 'index'])->name($controllerName);
            // Route::post('/',               [AdminArticleController::class, 'index']);
            Route::get('/create',             [AdminManagerController::class, 'create'])->name($controllerName.'.create')->middleware('isAdmin');
            Route::post('store',              [AdminManagerController::class, 'store'])->middleware('isAdmin');
            Route::get('/update/{id}',        [AdminManagerController::class, 'edit'])->name($controllerName.'.update');
            Route::post('/update/{id}',       [AdminManagerController::class, 'update']);
            Route::get('{action}/{id}',       [AdminManagerController::class, 'action'])->name($controllerName.'.action')->middleware('isAdmin');
